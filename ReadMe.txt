...
Group members: Mauricio Fossas, Matthew Schwartz, Reid Parisi.
...
We broke up the work as follows (some stuff for each person may be omitted accidentally):
Mauricio:
...
-Answered README questions and did testing
Reid:
-Worked on the display for the calendar
